	...
	<input type="hidden" value="${userEmail}" id="userEmail"/>
	 ...
	 <div class="container">
   	...
   	<form method="post" action="" id="testsForm" target="_blank">
		...
		<input type="hidden" value="${testsPublicId}" name="testsPublicId" id="testsPublicId"/>
...
<script type="text/javascript">
	...
	function initTests(courseNumber,currentCourseId){
		...
		$("#currentCourseId").val(currentCourseId);
				...
				var historyTestsObj = content.tests.getHistoryData($("#token").val(),courseNumber,$("#userEmail").val(),$("#domainUsername").val(),$("#sessionId").val(),$("#testsPublicId").val(),"${testsPosted.id}");
