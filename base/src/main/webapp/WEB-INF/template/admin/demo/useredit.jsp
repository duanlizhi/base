							...
							<div class="portlet-body">
								     ...
								     <tbody>
										...
										<tr>
											...
											<td>  
												<input class="m-wrap medium"  value="sujian" size="10" type="text" placeholder="用户名" />
											</td>

											<th class="hidden-480">密码</th>

											<td class="hidden-480">
												<input class="m-wrap medium" size="10" value="123456" type="text" placeholder="密码" />
											</td>
										...
										<tr>
											...
											<td>  
												<input class="m-wrap medium" size="10" type="text"  value="苏建" placeholder="姓名" />
											</td>

											<th class="hidden-480">邮箱</th>

											<td class="hidden-480">
												<input class="m-wrap medium" size="10" type="text" value="sujian@163.com" placeholder="邮箱" />
											</td>
										...
										<tr>
											...
											<td  colspan="3" class="hidden-480">
												<input type="text" class="m-wrap span12" size="16" value="苏建" type="text" placeholder="邮箱" >
										...
										<tr>
											...
											<td  colspan="3" class="hidden-480">
												<input type="text" class="m-wrap span12" size="16"  value="刘学涛"type="text" placeholder="邮箱" >
