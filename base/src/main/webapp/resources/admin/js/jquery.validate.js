...
$(function(){
    ...
    jQuery.validator.addMethod("isMobiles", function(value, element) {    
     ...
     // 匹配qq      5-12位  OK
    jQuery.validator.addMethod("isQQNo", function(value, element) {       
    ...
    // 匹配密码，以字母开头，长度在6-18之间，只能包含字符、数字和下划线。     OK 简单的密码校验   
    ...
    // 判断是否为合法字符(a-zA-Z0-9-_)  OK 少用
    jQuery.validator.addMethod("isRightfulString", function(value, element) {       
         return this.optional(element) || /^[A-Za-z0-9_-]+$/.test(value);       
    }, "判断是否为合法字符(a-zA-Z0-9-_)");   
    
    // 判断是否包含中英文特殊字符，除英文"-_"字符外 OK 
   ...
   //var pattern = new RegExp("[\\\\`~!@%#$^&*()=|{}':;',　\\[\\]<>/? \\.；：%……+￥（）【】‘”“'。，、？]"); 
	return this.optional(element)||!pattern.test(value) ; 
   	...
   	//<!--  上传的文件进行校验-->
	jQuery.validator.addMethod("validateImg", function(value, element) { 
		    var tel = /jpg|gif|png|jpeg|JPG|GIF|PNG|JPEG$/;
