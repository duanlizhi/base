...
//学习初始化
content.study.initStudy=function (token,courseNumber,userEmail,domainUsername,faultNumber,studyFlag){
	if(!content.pub.isAvailable){return false;}
	var objData = {
				token:token,
...
//学习开始
content.study.startStudy=function (token,courseNumber,userEmail,domainUsername,sessionId,faultNumber,studyFlag){
	if(!content.pub.isAvailable){return false;}
	var objData = {
			token:token,
			courseNumber:courseNumber,
