...
(function() {
	...
	function Ja(a, b) {
		...
		e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1;) {
			...
			if (d) {
				...
				h = S.lang,
				i = void 0,
				/f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = y.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep: ""))) : e = Oa(f, e)
			}
			j.push(e);
			a = a.slice(c + 1);
			c = (d = !d) ? "}": "{"
	...
	db = A.stop;
	S = {
		colors: "#454545,#cc0000,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#2b908f,#f45b5b,#91e8e1".split(","),
	...
	L.prototype = {
		...
		colorGradient: function(a, b, c) {
			...
			if (f) {
				...
				s = s.join(",");
				h[s] ? a = h[s].attr("id") : (g.id = a = "highcharts-" + yb++, h[s] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], m(j,
				function(a) {
		...
		zIndexSetter: function(a, b) {
			...
			if (e) {
				...
				d = c.childNodes;
				for (i = 0; i < d.length && !h; i++) if (e = d[i], f = I(e, "zIndex"), e !== g && (C(f) > a || !r(a) && r(f))) c.insertBefore(g, e),
				h = !0;
				h || c.appendChild(g)
			}
			return h
	...
	ta.prototype = {
		...
		buildText: function(a) {
			...
			c = this,
			d = c.forExport,
			e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = I(b, "x"), k = a.styles, l = a.textWidth, n = k && k.lineHeight, o = k && k.textShadow, s = k && k.textOverflow === "ellipsis", x = g.length, T = l && !a.added && this.box, B = function(a) {
				return n ? C(n) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize: k && k.fontSize || c.style.fontSize || 12, a).h
			},
			u = function(a) {
				return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
			}; x--;) b.removeChild(g[x]); ! f && !o && !s && e.indexOf(" ") === -1 ? b.appendChild(D.createTextNode(u(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, T && T.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), m(e,
			function(e, f) {
				var g, n = 0,
				...
				function(e) {
					if (e !== "" || g.length === 1) {
						...
						if (e !== " ") {
							...
							I(x, o);
							b.appendChild(x); ! n && f && (!ba && d && J(x, {
								display: "block"
							}), I(x, "dy", B(x)));
							if (l) {
								for (var o = e.replace(/([^\^])-/g, "$1- ").split(" "), m = g.length > 1 || f || o.length > 1 && k.whiteSpace !== "nowrap", T, r, ua, v = [], t = B(x), w = 1, q = a.rotation, z = e, y = z.length; (m || s) && (o.length || v.length);) a.rotation = 0,
								T = a.getBBox(!0),
								ua = T.width,
								!ba && c.forExport && (ua = c.measureSpanWidth(x.firstChild.data, a.styles)),
								T = ua > l,
								r === void 0 && (r = T),
								s && r ? (y /= 2, z === "" || !T && y < 0.5 ? o = [] : (T && (r = !0), z = e.substring(0, z.length + (T ? -1 : 1) * sa(y)), o = [z + "…"], x.removeChild(x.firstChild))) : !T || o.length === 1 ? (o = v, v = [], o.length && (w++, x = D.createElementNS(Ca, "tspan"), I(x, {
									dy: t,
									x: j
								}), p && I(x, "style", p), b.appendChild(x)), ua > l && (l = ua)) : (x.removeChild(x.firstChild), v.unshift(o.pop())),
								o.length && x.appendChild(D.createTextNode(o.join(" ").replace(/- /g, "-")));
		...
		button: function(a, b, c, d, e, f, g, h, i) {
			...
			p = h.style;
			delete h.style;
			K(j.element, ya ? "mouseover": "mouseenter",
			function() {
				k !== 3 && j.attr(f).css(s)
			});
			K(j.element, ya ? "mouseout": "mouseleave",
			function() {
				k !== 3 && (l = [e, f, g][k], n = [o, s, x][k], j.attr(l).css(n))
			});
			j.setState = function(a) { (j.state = k = a) ? a === 2 ? j.attr(g).css(x) : a === 3 && j.attr(h).css(p) : j.attr(e).css(o)
			};
			return j.on("click",
			function() {
				k !== 3 && d.call(j)
		...
		label: function(a, b, c, d, e, f, g, h, i) {
			function j() {
				...
				if (A) {
					if (!x) a = w( - B * u),
					b = h ? -H: 0,
					o.box = x = d ? n.symbol(d, a, b, o.width, o.height, E) : n.rect(a, b, o.width, o.height, 0, E[Nb]),
					x.attr("fill", M).add(o);
					x.isImg || x.attr(q({
						width: w(o.width),
						height: w(o.height)
			...
			function k() {
				...
				c !== v && s.attr(s.element.nodeName === "SPAN" ? "y": "translateY", c);
				s.x = b;
				s.y = c
			}
			function l(a, b) {
		...
		var Na = {
			...
			color: function(a, b, c, d) {
				...
				if (i) {
					...
					o = n.x2 || n[2] || 0,
					n = n.y2 || n[3] || 0,
					u = 'angle="' + (90 - V.atan((n - a) / (o - c)) * 180 / la) + '"',
					t();
					else {
						var j = n.r,
						v = j * 2,
	...
	Ta.prototype = {
		addLabel: function() {
			...
			r(d) ? d && d.attr({
				text: b
			}) : (this.labelLength = (this.label = d = r(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(z(g.style)).add(a.labelGroup) : null) && d.getBBox().width, this.rotation = 0)
		},
		...
		render: function(a, b, c) {
			...
			if (i && !isNaN(y)) i.xy = q = this.getLabelPosition(y, q, i, g, k, w, a, fa),
	...
	va.prototype = {
		...
		adjustForMinRange: function() {
			...
			f, g, h, i, j;
			if (this.isXAxis && this.minRange === v && !this.isLog) r(a.min) || r(a.max) ? this.minRange = null: (m(this.series,
			function(a) {
				i = a.xData;
		...
		setAxisTranslation: function(a) {
			...
			function(a) {
				...
				h > c && (h = 0);
				d = t(d, h);
				b.single || (f = t(f, Da(j) ? 0 : h / 2), g = t(g, j === "on" ? 0 : h)); ! a.noSharedTooltip && r(s) && (e = r(e) ? H(e, s) : s)
		...
		getTickAmount: function() {
			...
			b, c = this.options,
			d = c.tickAmount,
			e = c.tickPixelInterval; ! r(c.tickInterval) && this.len < e && !this.isRadial && !this.isLog && c.startOnTick && c.endOnTick && (d = 2); ! d && this.chart.options.chart.alignTicks !== !1 && c.alignTicks !== !1 && (m(this.chart[this.coll],
			function(c) {
				var d = c.options,
				c = c.horiz,
		...
		unsquish: function() {
			...
			c ? (l = r(h) ? [h] : f < 80 && !b.staggerLines && !b.step && b.autoRotation) && m(l,
			function(a) {
				var b;
				if (a === h || a && a >= -90 && a <= 90) j = n(P(i.h / $(ga * a))),
				b = j + P(a / 360),
				b < k && (k = b, g = a, e = j)
			}) : e = n(i.h);
			this.autoRotation = l;
		...
		render: function() {
			...
			if (x || f) {
				...
				n && m(g,
				function(b, c) {
					if (c % 2 === 0 && b < a.max) k[b] || (k[b] = new y.PlotLineOrBand(a)),
					u = b + o,
			...
			if (h && B) h[h.isNew ? "attr": "animate"](a.getTitlePosition()),
			h.isNew = !1;
	...
	va.prototype.getTimeTicks = function(a, b, c, d) {
		...
		if (r(b)) {
			...
			i = new Aa(i + Wa(i));
			h = i[Za]();
			for (var d = i.getTime(), l = i[Ya](), n = i[Xa](), o = (F.day + (g ? Wa(i) : i.getTimezoneOffset() * 6E4)) % F.day; d < c;) e.push(d),
			j === F.year ? d = gb(h + b * k, 0) : j === F.month ? d = gb(h, l + b * k) : !g && (j === F.day || j === F.week) ? d = gb(h, l, n + b * k * (j === F.day ? 1 : 7)) : d += j * k,
			b++;
			e.push(d);
			m(kb(e,
			function(a) {
	...
	Va.prototype = {
		init: function(a, b) {
			...
			this.pinchDown = [];
			this.lastValidTouch = {};
			if (y.Tooltip && b.tooltip.enabled) a.tooltip = new Kb(a, b.tooltip),
		...
		runPointActions: function(a) {
			...
			n,
			o;
			if (!e && !h) for (f = 0; f < c.length; f++) if (c[f].directTouch || !c[f].options.stickyTracking) c = []; (!h || !h.noSharedTooltip) && (e || !h) ? (m(c,
			function(b) {
			...
			if (n && (n !== g || d && d.isHidden)) {
				if (e && !n.series.noSharedTooltip) {
					f = l.length;
					for (c = n.clientX; f--;) h = l[f].clientX,
					(l[f].x !== n.x || h !== c || l[f].series.noSharedTooltip) && l.splice(f, 1);
				...
				n.onMouseOver(a)
			} else f = h && h.tooltipOptions.followPointer,
			d && f && !d.isHidden && (f = d.getAnchor([{}], a), d.updatePosition({
				plotX: f[0],
				plotY: f[1]
			}));
		...
		reset: function(a, b) {
			...
			e = c.hoverPoint,
			f = c.tooltip,
			g = f && f.shared ? c.hoverPoints: e; (a = a && f && g) && ra(g)[0].plotX === v && (a = !1);
			if (a) f.refresh(g),
			...
			function(b) {
				...
				if (d) d.onMouseOut();
				f && f.hide(b);
				if (this._onDocumentMouseMove) Y(D, "mousemove", this._onDocumentMouseMove),
	...
	q(y.Pointer.prototype, {
		...
		pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
			...
			w = !r && c[1][l],
			y,
			c = function() { ! r && P(q - v) > 20 && (m = h || P(t - w) / P(q - v));
				p = (o - t) / m + q;
	...
	mb.prototype = {
		...
		renderItem: function(a) {
			...
			if (!m) {
				...
				if (!this.baseline) this.baseline = c.fontMetrics(h.fontSize, m).f + 3 + s,
			...
			if (e && this.itemX - x + f > (n || b.chartWidth - 2 * j - x - d.x)) this.itemX = x,
	...
	A.prototype = {
		...
		getContainer: function() {
			...
			a || ka(13, !0);
			c = C(I(a, "data-highcharts-chart")); ! isNaN(c) && X[c] && X[c].hasRendered && X[c].destroy();
		...
		setSize: function(a, b, c) {
			...
			if (r(a)) d.chartWidth = e = t(0, w(a)),
			d.hasUserSize = !!e;
			if (r(b)) d.chartHeight = f = t(0, w(b)); (za ? lb: J)(d.container, {
				width: e + "px",
				height: f + "px"
			},
			za);
		...
		drawChartBox: function() {
			...
			if (l) h ? h.animate(u) : this.plotBGImage = b.image(l, s, p, m, r).add();
			q ? q.animate({
				width: t.width,
				height: t.height
	...
	R.prototype = {
		...
		generatePoints: function() {
			...
			b = this.data = b;
			for (n = 0; n < g; n++) i = h + n,
			j ? l[n] = (new f).init(this, [d[n]].concat(ra(e[n]))) : (b[i] ? k = b[i] : a[i] !== v && (b[i] = k = (new f).init(this, a[i], d[n])), l[n] = k),
			l[n].index = i;
		...
		getExtremes: function(a) {
			...
			d = a.length;
			for (l = 0; l < d; l++) if (j = c[l], k = a[l], i = k !== null && k !== v && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j) if (i = k.length) for (; i--;) k[i] !== null && (e[f++] = k[i]);
			else e[f++] = k;
		...
		translate: function() {
			...
			h = !!this.modifyValue,
			i = a.pointPlacement,
			j = i === "between" || qa(i), k = a.threshold, l, n, o, s = Number.MAX_VALUE, a = 0; a < g; a++) {
				var m = f[a],
				q = m.x,
				B = m.y;
				n = m.low;
				var u = b && e.stacks[(this.negStacks && B < k ? "-": "") + this.stackKey];
				if (e.isLog && B !== null && B <= 0) m.y = B = null,
				ka(10);
				m.plotX = l = c.translate(q, 0, 0, 0, 1, i, this.type === "flags");
				if (b && this.visible && u && u[q]) u = u[q],
		...
		drawPoints: function() {
			...
			m = !!g.marker, a = t && o.enabled === v || o.enabled, x = g.isInside, a && e !== v && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select": ""] || n, h = a.r, i = p(o.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[x ? "show": "hide"](!0).animate(q({
				x: d - h,
				y: e - h
			},
			k.symbolName ? {
		...
		redraw: function() {
			...
			this.translate();
			this.render();
			b && G(this, "updatedData"); (c || b) && delete this.kdTree
		},
		kdDimensions: 1,
		kdTree: null,
	...
	q(R.prototype, {
		addPoint: function(a, b, c, d) {
			...
			n, o = this.xData;
			Sa(d, i);
			c && m([g, h, this.graphNeg, this.areaNeg],
			function(a) {
				if (a) a.shift = k + 1
			});
			if (h) h.isArea = !0;
	...
	Q = {
		...
		pointClass: ja(Ga, {
			...
			setVisible: function(a) {
				...
				m(["graphic", "dataLabel", "connector", "shadowGroup"],
				function(c) {
	...
	if (N.pie) N.pie.prototype.drawDataLabels = function() {
		...
		if (a.visible && (e.enabled || a._hasPointLabels)) {
				...
				if (M) {
					...
					if (n > 0) {
						...
						for (E = 0; E < M; E++) {
							...
							c = 9999;
							var S, Q;
							for (Q = 0; Q < u; Q++) S = P(K[Q] - z[1]),
							S < c && (c = S, L = Q);
							if (L < E && K[E] !== null) L = E;
							else for (u < M - E + L && K[E] !== null && (L = u - M + E); K[L] === null;) L++;
							O.push({
								i: L,
								y: K[L]
							});
					...
					for (E = 0; E < M; E++) {
						...
						y.connX = C;
						y.connY = A;
						if (this.options.size === null) u = y.width,
						C - u < f ? G[3] = t(w(u - C + f), G[3]) : C + u > h - f && (G[1] = t(w(C + u - h + f), G[1])),
						A - b / 2 < 0 ? G[0] = t(w( - A + b / 2), G[0]) : A + b / 2 > i && (G[2] = t(w(A + b / 2 - i), G[2]))
					}
				}
			}
			...
			function(b) {
				j = b.connector;
				z = b.labelPos;
				if ((y = b.dataLabel) && y._pos) F = y._attr.visibility,
				C = y.connX,
				A = y.connY,
				k = l ? ["M", C + (z[6] === "left" ? 5 : -5), A, "C", C, A, 2 * z[2] - z[4], 2 * z[3] - z[5], z[2], z[3], "L", z[4], z[5]] : ["M", C + (z[6] === "left" ? 5 : -5), A, "L", z[2], z[3], "L", z[4], z[5]],
				j ? (j.animate({
					d: k
