...
@Entity(name="SbtQuestion")
@Table(name="sbt_question")
@SequenceGenerator(name="sequenceGenerator",sequenceName="secquence_sbt_question")
public class SbtQuestion extends BaseEntity  implements java.io.Serializable{
    /**
		 * 
    ...
    @Column(name="sbt_fault_id",nullable = false, length=10)
