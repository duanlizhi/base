...
@Entity(name="CourseWareScores")
@Table(name="course_ware_scores")
@SequenceGenerator(name="sequenceGenerator",sequenceName="secquence_course_ware_scores")
public class CourseWareScores extends BaseEntity  implements java.io.Serializable{
    /**
		 * 
    ...
    private Integer  courseWareId;//courseWare id
