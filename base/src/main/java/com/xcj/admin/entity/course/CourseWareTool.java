...
@Entity(name="CourseWareTool")
@Table(name="course_ware_tool")
@SequenceGenerator(name="sequenceGenerator",sequenceName="secquence_course_ware_tool")
public class CourseWareTool extends BaseEntity  implements java.io.Serializable{
    ...
    @Column(name="tool_id",nullable = false, length=20)
