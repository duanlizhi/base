 ...
 * @author name su_jian
 */
@Component("courseWareToolDaoImpl")
@SuppressWarnings({ "hiding" })
public class CourseWareToolDaoImpl extends BaseDaoImpl implements
		CourseWareToolDao {
	...
	public <T extends CourseWareTool> List<T> getAllList()
		...
		String hql = "from CourseWareTool";
	...
	public Page<CourseWareTool> getByCourseWareToolPage(
			Page<CourseWareTool> page, CourseWareTool courseWareTool)
			throws DataAccessException {
		try {
			...
			page.setResult(session
					.createQuery(
							"from " + courseWareTool.getClass().getName()
									+ " order by orders ")
					.setFirstResult(
			...
			page.setTotalsCount(Integer.parseInt(session
					.createQuery(
							"select count(id) as cnt from "
									+ courseWareTool.getClass().getName())
	...
	public void removeById(Integer id) throws DataAccessException {
		super.delete("delete from CourseWareTool t where t.id=" + id);
	}
	...
	public List<CourseWareTool> getByCourseWareIds(String cwids)
			throws DataAccessException {
		String hql = "from CourseWareTool where courseWareId in ("+cwids+")";
		return super.getList(hql);
	}
