 ...
 *
  ...
  * @author name su_jian
 */
public interface CourseWarePartsDao extends BaseDao{
  ...
  * @author name su_jian
    */
  public <T extends CourseWareParts> List<T> getAllList()	throws DataAccessException;
  ...
  * @author name su_jian
    */
  public Page<CourseWareParts>  getByCourseWarePartsPage(Page<CourseWareParts> ps,CourseWareParts courseWareParts)	throws DataAccessException;
...
/** 
  ...
  *  <dd> 2015年10月16日 下午3:42:52</dd></dl> 
  ...
  */
public List<CourseWareParts> getByCourseWareIds(String cwids)throws DataAccessException;
