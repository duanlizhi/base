...
public interface BaseDao{
     ...
     * @createDate 2014-03-30 下午05:28:38 
     * @author su_jian 
     * @param <T> 对象类型 
     * @param entity 对象 
     ...
     * @createDate 2014-03-30 下午05:29:39 
     * @author su_jian 
     * @param <T> 对象类型 
     ...
     * @createDate 2014-03-30 下午05:31:32 
     * @author su_jian 
     * @param <T> 对象类型 
     * @param entity 将要添加的对象 
     * @return String 返回的主键 
     ...
     * @createDate 2014-03-30 下午04:42:26 
     * @author su_jian 
     ...
     * @createDate 2014-03-30 下午05:33:42 
     * @author su_jian 
     ...
     * @createDate 2014-03-30 下午05:35:47 
     * @author su_jian 
     * @param <T> 对象类型 
     ...
     * @createDate 2014-03-30 下午05:36:31 
     * @author su_jian 
     * @param hql 查询的hql语句 
     ...
     * @createDate 2014-03-30 下午05:38:58 
     * @author su_jian 
     * @param hql 修改语句 
     * @return int 返回修改的行数 
     * @throws DataAccessException 
     ...
     * @createDate 2014-03-30 下午05:42:02 
     * @author su_jian 
     * @param <T> 传入对象类型 
     ...
     * @createDate 2014-03-30 下午05:44:53 
     * @author su_jian 
     * @param <T> 返回、传入对象类型 
     * @param c 对象Class 
     * @param id 主键 
     ...
     * @createDate 2014-03-30 下午05:47:20 
     * @author su_jian 
     * @param <T> 返回、传入对象类型 
     * @param c 对象Class 
     * @param id 主键 
     ...
     * @createDate 2014-03-30 下午05:48:36 
     * @author su_jian 
     * @param <T> 返回、传入对象类型 
     * @param c 对象Class 
     * @param id 主键 
     ...
     * @createDate 2014-03-30 下午05:49:31 
     * @author su_jian 
     * @param <T> 返回对象类型 
     * @param hql 查询的hql语句 
     * @return 对象T 
     ...
     * @createDate 2014-03-30 下午05:51:05 
     * @author su_jian 
     * @param hql 查询hql语句 
     * @return List<?> 
     * @throws DataAccessException 
     ...
     * @createDate 2014-03-30 下午05:52:36 
     * @author su_jian 
     * @param hql 查询的hql语句 
     * @param obj 查询参数 
     * @return 返回list集合 
     ...
     * list集合保存总记录调试和记录结果 
     * @createDate 2014-03-30 下午05:54:01 
     * @author su_jian 
     ...
     * @throws DataAccessException 
     */  
    public List<?> getByPage(String queryHql, String queryCountHql, int firstResult, int maxResult) throws DataAccessException;  
     ...
     * @throws DataAccessException 
     */  
    public <T> Page<T> getByPage(Page<T> page,T entity) throws DataAccessException;  
     ...
     * @throws DataAccessException 
     */  
    public List<?> getByPage(String queryCountHql, DetachedCriteria cResult, int firstResult, int maxResult) throws DataAccessException;  
     ...
     * @throws DataAccessException 
     */  
    public <T> void getByPage(String queryCountHql, DetachedCriteria cResult, Page<T> page) throws DataAccessException;  
     ...
     * @return List 
     */  
    public  <T>int saveOrUpdateOrDeleteByJDBC(String sql,Object[] parameters, Class<T> cl) throws DataAccessException;
