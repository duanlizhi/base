...
public class BaseServiceImpl implements BaseService {
	...
	public <T> boolean save(T entity) throws Exception{
		boolean bo = false;
		try {
			Serializable io = baseDao.save(entity);
			if (io != null) {
				bo = true;
			}
		} catch (Exception e) {
	...
	public <T> Integer saveAndGetIdByInteger(T entity) throws DataAccessException {
		Integer id = null;
		try {
			id = (Integer)baseDao.saveAndGetIdByInteger(entity);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
		return id;
	...
	public <T> String saveAndGetIdByString(T entity) throws DataAccessException {
		String id = null;
		try {
			id = (String) baseDao.saveAndGetIdByString(entity);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
		return id;
	...
	public <T> List<T> findByHql(String hql) throws DataAccessException {
		List<T> list = null;
		try {
			list = (List<T>) baseDao.findByHql(hql);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
		return list;
	...
	public <T> List<T> findBySql(String sql) throws DataAccessException {
		List<T> list = null;
		try {
			list = (List<T>)baseDao.findBySql(sql);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
		return list;
	...
	public <T> List<T> getList(String hql) throws DataAccessException {
		List<T> list = null;
		try {
			list = (List<T>) baseDao.getList(hql);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
		return list;
	...
	public <T> List<T> getList(String hql, Object[] obj) throws DataAccessException {
		List<T> list = null;
		try {
			list = (List<T>) baseDao.getList(hql, obj);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
		return list;
	...
	public List<?> getByPage(String queryHql, String queryCountHql,
		...
		try {
			list= (List<Object>) baseDao.getByPage(queryHql, queryCountHql, firstResult, maxResult);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
		return list;
	...
	public <T> Page<T>  getByPage(Page<T> page,T entity)
			throws DataAccessException {
		try {
			return baseDao.getByPage(page,entity);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}
	...
	public List<?> getByPage(String queryCountHql, DetachedCriteria cResult,
		...
		List<Object> list = new ArrayList<Object>();
		try {
			list=(List<Object>) baseDao.getByPage(queryCountHql, cResult, firstResult,maxResult);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
		return list;
	...
	public <T> void getByPage(String queryCountHql, DetachedCriteria cResult,
		...
		try {
			baseDao.getByPage(queryCountHql, cResult, page);
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}
	...
	public Object findUniqueEntity(final String hql, final Object[] values) throws DataAccessException{
		 return baseDao.findUniqueEntity(hql, values);
	}
	   /**
	 * 按属性查找对象列表.
	 */
	...
	public <T> List<T> findByReProperty(Class<T> entityClass,
	   	 ...
	   	 return baseDao.findByReProperty(entityClass, propertyName,value,value2);
	}
	...
	public <T> void deleteEntityByIds(Class<T>  entityName, String ids) {
		baseDao.deleteEntityByIds(entityName, ids);
	}
	/**
	 * 获取所有实体
	 * @param <T>
