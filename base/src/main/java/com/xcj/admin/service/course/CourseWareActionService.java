...
import com.xcj.admin.base.BaseService;
  ...
  * @author name su_jian
 */
public interface CourseWareActionService extends BaseService{
  ...
  * @author name su_jian
    */
 public  Page<CourseWareAction>  getByCourseWareActionPage(Page<CourseWareAction> ps,CourseWareAction courseWareAction) throws Exception;

   /**
    *
     * <b>function:</b>  course_ware_actioncourse_ware动作---获取所有数据方法
     * @project base
     * @package com.xcj.admin.service.course.
     * @fileName com.xcj.admin.*
     * @createDate Fri Oct 16 15:21:32 CST 2015
  ...
  * @author name su_jian
    */
   List<CourseWareAction>  getAllList()  throws Exception;
...
/** 
  ...
  *  <dd> 2015年10月16日 下午3:34:27</dd></dl> 
  ...
  */
public List<CourseWareAction> getByCourseWareIds(String cwids)throws Exception;
}
