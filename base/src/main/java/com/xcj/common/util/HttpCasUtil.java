...
public class HttpCasUtil {
	...
	private static final Logger logger = LoggerFactory.getLogger(HttpCasUtil.class);
	...
	public static String getTicketGrantingTicket(final String server, final String username, final String password) {
		...
		try {
			...
			warning(e.getMessage());
			logger.error(HttpCasUtil.class.getName()+" logout() exception: "+e.getMessage());
		}
...
//	 for (int i = 0; i < 899999229; i++) {
//		   final String server = "http://10.0.0.197:8082/v1/tickets";
//			final String username = "admin";
//			final String password = "admin";
//			final String service = "http://www.xcj.com";
//			final String proxyValidate = "http://10.0.0.197:8082/proxyValidate";
//			String t=getTicket(server, username, password, service);
//			//System.out.println(":::t:::"+t);
//			 ticketValidate(proxyValidate,t,service );
//		     	//首次登录使用方法
...
//	}
	 ...
	 /**
		 *   //System.out.println("tgt:"+tgt);
 		 ...
 		 String result=ticketValidate(proxyValidate,st, service);
