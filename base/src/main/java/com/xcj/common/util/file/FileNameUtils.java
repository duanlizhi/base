package com.xcj.common.util.file;
...
import com.xcj.common.util.common.Num62;
...
public class FileNameUtils {
	...
	public static String genFileName() {
		return System.currentTimeMillis()
				+ RandomStringUtils.random(6, Num62.N62_CHARS);
	}
	...
	public static void main(String[] args) {
		System.out.println(getFileSufix("a.jpg"));
