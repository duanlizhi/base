...
public class GetStartCommitExitTest {
	@Resource(name = "domainServiceImpl")
	private DomainService domainService;
	private static JSONObject objs=null;
	private static String chara="";
	private static final String userEmail="sujiansdf@163.com";

	private static final Logger log = LoggerFactory.getLogger(GetStartCommitExitTest.class);
	...
	public void before() {
			...
			params.put("studyFlag", "{'id':'123123'}");
	...
	public void testAStartStudy_OK() {
		...
		json.put("courseNumber", "SBT_VER_001");
		json.put("faultNumber", "SBT_VER_ES_EC_001_FAULT");
	...
	@Test
	public void testCommit_OK_TEST() {
		System.out.println(objs.toJSONString());
		String url = "http://content.xiaochejiang.com/api/oper/study/commitStudy";
		Map<String, String> params = new HashMap<String, String>();
		JSONObject json =new JSONObject();
